...
public void close() throws IOException 
    ...
    public static void main(String args[])throws IOException
    {
       ...
       int t=1;
        ...
        while(t--!=0)
        {
        	   ...
        	   System.out.println(getSol(n1,n2,l_f,l_h));
    ...
    public static int getSol(int f,int h,int k1,int k2)
    {
    	if(f+h==0) return 1;
    	 int mod=100000000;
    	...
    	int x=0;
    	if(f>0 && k1>0) x=getSol(f-1,h,k1-1,l_h);
    	//h
    	int y=0;
    	if(h>0 && k2>0) y=getSol(f,h-1,l_f,k2-1);
