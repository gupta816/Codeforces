...
public void close() throws IOException 
    ...
    public static void main(String args[])throws IOException
    {
         ...
         */
   	    ...
   	    String st2=inputString();
   	    String[] arr=st2.split(" ",5);
   	    int flag=0;
   	    for(int i=0;i<5;i++)
   	    {
  
   	        if(arr[i].charAt(0)==st.charAt(0) || arr[i].charAt(0)==st.charAt(1) || arr[i].charAt(1)==st.charAt(0) || arr[i].charAt(1)==st.charAt(1))
   	        {
   	            flag=1;
   	        }
   	    }
