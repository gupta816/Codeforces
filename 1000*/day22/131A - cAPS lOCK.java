...
public void close() throws IOException 
    ...
    public static void main(String args[])throws IOException
    {
      ...
      // int t=inputInt();
    	...
    	while(t--!=0){
    		...
    		else if(st.substring(1,st.length()).equals(ss.substring(1,st.length())))
    		{
    			println(String.valueOf(st.charAt(0)).toUpperCase()+ss.toLowerCase().substring(1,st.length()));
    		}
    		else {
    			println(st);
    		}
    ...
    public static boolean is(int arr[],int arr1[],int n)
    {
    	Arrays.sort(arr);
    	Arrays.sort(arr1);
    	for(int i=0; i<n; ++i)
